...
(function initTerminal() {
  ...
  const COMMANDS = {
    ...
    whoami: () => [
      ...
      'Data Analyst / Tech Business Analyst Intern @ Anvex AI',
    ...
    experience: () => [
      ...
      '&nbsp;&nbsp;<span class="t-hint">Mar 2026 &ndash; Jun 2026</span>  Tech Business Analyst Intern, Anvex AI',
      '&nbsp;&nbsp;&nbsp;&nbsp;&rarr; Automated call reporting with VBA macros (85% efficiency gain)',
      '&nbsp;&nbsp;&nbsp;&nbsp;&rarr; Vision AI evaluation frameworks across 3,421+ alerts',
      '&nbsp;&nbsp;&nbsp;&nbsp;&rarr; AI calling analytics pipeline (Python + Power BI)',
    ],
    education: () => [
